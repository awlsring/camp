...
import (
	...
	"github.com/awlsring/camp/apps/local/internal/adapters/primary/rest/ogen/auth"
	"github.com/awlsring/camp/apps/local/internal/adapters/primary/rest/ogen/smithy/exception"
